...
public class CommonLexerRules extends Lexer {
	...
	public static final int
		IMPRESION=1, IF_BASICO=2, ELSE=3, ELSE_IF=4, INT=5, FLOAT=6, CHAR=7, MUL=8, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IMPRESION", "IF_BASICO", "ELSE", "ELSE_IF", "INT", "FLOAT", "CHAR", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'leak'", "'si'", "'else'", "'elfito'", "'nc'", "'im'", "'jgl'", 
			"'*'", "'/'", "'+'", "'-'", "'='", "'>'", "'<'", "'>='", "'<='", "'=='", 
			"'==='", "'!='", "'!=='", "'||'", "'&&'", "'W7HLM'", "'{'", "'}'", "'('", 
			"')'", "'!'", null, null, null, null, "';'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "IMPRESION", "IF_BASICO", "ELSE", "ELSE_IF", "INT", "FLOAT", "CHAR", 
			"MUL", "DIV", "ADD", "SUB", "ASIGNACION", "MAYORQ", "MENORQ", "MAYOR_IGUAL", 
			"MENOR_IGUAL", "IGUALDAD_DEBIL", "IGUALDAD_FUERTE", "DIF_DEBIL", "DIF_FUERTE", 
			"OR", "AND", "TPG", "ALLAVE", "CLLAVE", "APARENTESIS", "CPARENTESIS", 
			"AADMIRACION", "ID", "NUM", "CADENA", "DEC", "SEMI", "WS"
